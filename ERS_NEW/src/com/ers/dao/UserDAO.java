...
public class UserDAO {
    ...
    public User authenticate(String username, String password) {
        String sql = "SELECT u.*, s.student_id, s.student_code, s.first_name, s.last_name "
        ...
        try (PreparedStatement ps = conn.prepareStatement(sql)) {
            ...
            if (rs.next()) {
                ...
                if ("STUDENT".equals(role)) {
                    return new Student(uid, uname, email, role,
                    ...
                    return new User(uid, uname, email, role) {
                        ...
                        public void displayDashboard() {
                            if ("ADMIN".equals(role)) {
                                ...
                                System.out.println("  4.  Manage Exam Schedule");
                                System.out.println("  5.  View All Registrations");
                                System.out.println("  6.  Approve / Cancel Registration");
                                System.out.println("  7.  Issue Hall Tickets");
                                System.out.println("  8.  Enter Results");
                                System.out.println("  9.  Publish Results");
                                System.out.println("  10. View Results");
                                System.out.println("  11. Reports");
                                System.out.println("  12. Manage Users");
                                System.out.println("  13. System Logs");
                                System.out.println("  14. Logout");
                            } else {
                                System.out.println("  1.  Manage Subjects");
                                System.out.println("  2.  Manage Exams");
                                System.out.println("  3.  Manage Exam Schedule");
                                System.out.println("  4.  View All Registrations");
                                System.out.println("  5.  Approve / Cancel Registration");
                                System.out.println("  6.  Issue Hall Tickets");
                                System.out.println("  7.  Enter Results");
                                System.out.println("  8.  Publish Results");
